...
const (
	...
	DebugMessageImpressionForTrackCustomGoal   	= "[%v] impression built for track goal - %+v"
	DebugMessageImpressionForTrackRevenueGoal  	= "[%v] impression built for track goal - %+v"
	...
	InfoMessageMainKeysForPushAPI             	= "[%v] Having main keys: %+v"
	InfoMessageMainKeysForImpression          	= "[%v] Having main keys: %+v"
