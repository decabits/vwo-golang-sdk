...
const (
	...
	ErrorMessageNoCampaignFoundForKeys                  = "[%v] No campaign found for Campaign Keys: [%v]. Please verify from VWO app."
	...
	ErrorMessageTrackAPIMissingParams                   = "[%v] track API got bad parameters. It expects campaignKey(String / array of string / nil) as first, User ID(String) as second, goalIdentifier(String) as third argument and options(Optional) as fourth parameter"
