...
const (
	...
	DebugMessageSegmentationSkippedForVariation = "[%v] For User ID: %v of CampaignKey: %v Variation Targetting variables are missing, hence skipping segmentation for variation %v "
	DebugMessageSegmentationStatusForVariation  = "[%v] For User ID: %v of Campaign: %v with Variation Targetting variables: %v, Segments: %v, %v, %v for variation %v "
	...
	InfoMessageSegmentationStatusForVariation   = "[%v] For User ID: %v of Campaign: %v with Segments: %v, Variation targetting Variables: %v, %v, %v for variation %v "
